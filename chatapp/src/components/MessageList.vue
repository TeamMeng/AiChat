                ...
                <div class="max-w-4/5">
                    <div class="flex items-center mb-1">
                        ...
                        <button
                            ...
                            class="ml-2 text-[#9399b2] hover:text-[#f38ba8] transition-colors duration-200"
    ...
    methods: {
        ...
        getMessageContent(message) {
            ...
            if (message.senderId === this.$store.state.user.id) {
                ...
                return message.modifiedContent &&
                    message.modifiedContent.trim() !== ""
                    ? message.modifiedContent
                    : message.content;
            }
        },
        isOwnMessage(message) {
            return this.$store.state.user && message.senderId === this.$store.state.user.id;
        },
